...
export class ContextService {
  ...
  static async create(rootDir: string, openaiService: OpenAIService): Promise<ContextService> {
    const service = new ContextService(rootDir, openaiService);
    await service.initialize();
    return service;
  }
  
  private async initialize() {
    console.log("Initializing ContextService");
